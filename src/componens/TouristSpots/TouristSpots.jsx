            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                {
                    spots.slice(3, 9).map(spot => (
                        <div className="md:h-72 h-[250px] rounded-xl bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${spot?.image}})` }}>
                                ...
                                <div className="flex flex-col min-h-full">
                                    ...
                                    <div className="flex flex-grow flex-col justify-end items-start text-white">
                                        <div>
                                            ...
                                            <p className="font-medium mt-1 text-sm md:text-base text-center lg:text-left">
                                                {spot?.description}
                                            </p>
