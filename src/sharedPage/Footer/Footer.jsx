                ...
                <div className="container px-6 mx-auto space-y-6 divide-y md:space-y-12 divide-opacity-50">
                    <div className="grid lg:grid-cols-12 gap-10 md:gap-20    ">
                        <div className="pb-6 md:pb-0 md:col-span-3">
                            ...
                            <div>
                                <h3 className='text-2xl font-bold mb-3'>Follow Us On:</h3>
                                <div className='flex gap-3'>
                                    <a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#2BA2FF] text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                            <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                            <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                                        </svg>
                                    </a>
                                    <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#2BA2FF] text-white">
                                    ...
                                    <a rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#2BA2FF] text-white">
                        ...
                        <div className="text-center md:text-left lg:col-span-3">
                            ...
                            <ul className='space-y-1'>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:text-[#2BA2FF]">Wild & Adventure <br /> Tours
                                    </a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:text-[#2BA2FF]">Group Tour</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:text-[#2BA2FF]">Seasonal Tours</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:text-[#2BA2FF]"> Relaxation Tours</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:text-[#2BA2FF]">Family Friendly Tours</a>
                                </li>
                            </ul>
                        </div>
                        <div className="text-center md:text-left lg:col-span-3">
